...
PICS = (environ.get('PICS', 'https://telegra.ph/file/cc65f6174d93ef5cbfc67.jpg')).split()

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5003412543 1304785841').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5003412543 1304785841').split()]
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'RtmFilesHub')

# Others
LOG_CHANNEL = int(environ.get('-1002103774206', 0))
